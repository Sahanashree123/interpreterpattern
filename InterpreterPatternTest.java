...
public class InterpreterPatternTest {
    ...
    private static void testExpression(String contextString, String day, String month, String year) {
        ClsContext contextObject = new ClsContext(contextString);
        System.out.println("Our context is " + contextString);
